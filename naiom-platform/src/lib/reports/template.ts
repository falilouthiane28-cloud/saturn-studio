...
export interface Report {
  title: string;
  subtitle?: string;
  brand?: string; // défaut : "Saturn Studio"
...
export function renderReportHTML(report: Report): string {
  const brand = (report.brand ?? "Saturn Studio").toUpperCase();
  ...
  <section class="cover">
    ...
    <div class="cover-footer">
      <div class="cover-footer-meta">
        ...
        <span>${escapeHtml(report.author ?? "Plateforme Saturn Studio — Agents IA")}</span>
      </div>
