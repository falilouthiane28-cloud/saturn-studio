 ...
 * #6D28D9 / violet #5B4DEE / Archivo), identique aux visuels coulisses.
 *
...
- orange #6D28D9 · violet #5B4DEE · vert #188A5C · encre #0F0F0F · crème #FFFDF9
...
- BARRE DE PROMPT en bas où le texte se tape : entoure le <text> d'un clipPath animé
  ...
  + un curseur class="blink" (▌). La commande en orange, ex <tspan fill="#6D28D9" font-weight="700" class="mt">/goal</tspan>.
...
const BRONX_CSS = `
:root{--bronx:#6D28D9;--violet:#5B4DEE;--ink:#0F0F0F;--font-display:'Archivo';--font-sans:'Inter';--font-mono:'JetBrains Mono',monospace}
...
.lv-mark.m3{background:#ede4fd;outline-color:#6d28d980}
...
.lv-mark.m3:before,.lv-mark.m3:after{background:#6D28D9}
