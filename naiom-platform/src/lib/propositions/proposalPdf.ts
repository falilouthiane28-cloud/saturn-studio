...
const C = { orange: "#6D28D9", violet: "#5B4DEE", ink: "#141414", soft: "#5b6170", line: "#e8e8ee", wash: "#FAF6F4" };
...
function solutionBlock(s: Solution, i: number): string {
  return `<section class="sol">
    ...
    <div class="ba">
      ...
      <div style="margin-top:8px"><div class="ba-label ba-after">Avec Saturn Studio — automatisé</div>${flow(s.after, "accent")}</div>
    </div>
    <div class="sol-foot">
...
<div class="cover">
  <div><div class="brand">Saturn Studio<span class="dot">.</span></div><div class="brand-tag">Ingénierie d'agents IA & automatisations</div></div>
...
<div class="block">
  ...
  <div class="sign">Saturn Studio · contact@saturnstudio.com · Proposition ${esc(p.reference)} — ${esc(p.prospect)}</div>
</div>
