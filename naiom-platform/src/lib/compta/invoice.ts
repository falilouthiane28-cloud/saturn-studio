/**
 * Génère une facture PDF de marque Saturn Studio à partir d'une facture Airtable.
...
const ISSUER = {
  ...
  email: "contact@saturnstudio.com",
  color: "#6D28D9",
  ink: "#1A1A1A",
};
...
<div class="page">
  <div class="top">
    <div>
      <div class="brand">Saturn Studio<span class="dot">.</span></div>
  ...
  <table>
    ...
    <tbody>
      <tr><td class="desc">Prestation Saturn Studio — ${c?.category ? c.category : "services"}</td><td class="r">${eur(inv.ht)}</td></tr>
    </tbody>
  </table>
