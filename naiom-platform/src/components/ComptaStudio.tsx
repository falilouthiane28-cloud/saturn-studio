  ...
  return (
    <div className="space-y-5">
      ...
      <div className="althea-card overflow-hidden">
        <div className="flex items-center justify-between px-4 py-2.5" style={{ background: "linear-gradient(90deg,var(--color-primary),#7A1E0C)" }}>
...
function RelanceRow({ r, onPrepare }: { r: Relance; onPrepare: () => void }) {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3">
      ...
      <button onClick={onPrepare} className="shrink-0 flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[12px] font-bold text-white hover:opacity-90" style={{ background: "var(--color-primary)" }}>
      ...
      <div className="flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-[var(--color-bg)]" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="grid flex-1 gap-0 overflow-hidden md:grid-cols-[1fr_1.1fr]">
          ...
          <div className="flex flex-col gap-3 overflow-y-auto p-5">
            ...
            <a href={d.downloadUrl} target="_blank" rel="noreferrer" className="text-[12px] font-bold text-[var(--color-accent,var(--color-primary))] md:hidden">Voir la facture PDF ↗</a>
