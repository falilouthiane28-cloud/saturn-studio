    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
          {products.map((p) => {
            ...
            return (
              <div
                ...
                style={isSelected ? { outline: "3px solid var(--color-primary)", outlineOffset: 3 } : undefined}
              >
                {isSelected && (
                  <span className="absolute top-2 right-2 z-10 inline-flex items-center gap-1 rounded-full bg-[var(--color-primary)] px-2.5 py-1 text-[10.5px] font-black text-white shadow-md">
                ...
                <button
                  ...
                  className="absolute top-2 left-2 z-10 flex h-7 w-7 items-center justify-center rounded-full bg-white/90 text-[#8A8A8A] opacity-0 shadow-md transition-opacity group-hover/prod:opacity-100 hover:bg-[var(--color-primary)] hover:text-white"
                >
                ...
                <div className="px-3 py-2.5">
                  <div className={cn("text-[13px] font-bold truncate", isSelected && "text-[var(--color-primary)]")}>
                    {p.name}
                  </div>
          ...
          <button
            ...
            className="althea-card flex flex-col items-center justify-center gap-2 aspect-auto min-h-[140px] border-dashed text-[#5A5A5A] hover:text-[var(--color-primary)]"
        ...
        {showNewProduct && (
          <div className="althea-card mt-4 p-5 grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-5">
            <button
              ...
              className="aspect-square rounded-2xl border-2 border-dashed border-[#C9C6BE] flex items-center justify-center overflow-hidden bg-[#F7F6FC] hover:border-[var(--color-primary)]"
            >
              {newPhotoPreview ? (
                // eslint-disable-next-line @next/next/no-img-element
            ...
            <div className="space-y-3">
              <input
                ...
                className="w-full rounded-xl border border-[#E4E1F5] px-4 py-2.5 text-[14px] outline-none focus:border-[var(--color-primary)]"
              />
              <textarea
                value={newDesc}
                ...
                rows={2}
                className="w-full rounded-xl border border-[#E4E1F5] px-4 py-2.5 text-[14px] outline-none focus:border-[var(--color-primary)] resize-none"
              />
              <button
                type="button"
      ...
      {mode === "avatar" ? (
        <section>
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {AVATAR_PRESETS.map((p) => (
              <button
                ...
                className="rounded-full border border-[#E4E1F5] bg-white px-3.5 py-2 text-[12.5px] font-bold hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors"
              >
                {p.label}
              </button>
            ))}
            ...
            <div className="relative inline-flex items-center">
              ...
              <input
                ...
                className={cn(
                  ...
                  voiceId ? "border-[#188A5C]" : "border-[#E4E1F5] focus:border-[var(--color-primary)]"
                )}
              />
              {voiceId && (
          ...
          <textarea
            ...
            rows={4}
            className="w-full rounded-xl border border-[#E4E1F5] px-4 py-3 text-[14px] leading-relaxed outline-none focus:border-[var(--color-primary)] resize-none"
          />
        ...
        <section>
          ...
          <textarea
            ...
            rows={3}
            className="w-full rounded-xl border border-[#E4E1F5] px-4 py-3 text-[14px] leading-relaxed outline-none focus:border-[var(--color-primary)] resize-none mb-4"
          />
          <div className="flex flex-wrap items-center gap-2 mb-4">
              ...
              <button
                ...
                className={cn(
                  ...
                  aspectRatio === r
                    ...
                    : "bg-white border-[#E4E1F5] hover:border-[var(--color-primary)]"
                )}
              >
      ...
      <section className="althea-card p-5 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        <input
          ...
          className="flex-1 rounded-xl border border-[#E4E1F5] px-4 py-2.5 text-[14px] outline-none focus:border-[var(--color-primary)]"
        />
        <button
          type="button"
          onClick={generate}
                ...
                <div className="p-4 flex-1 flex flex-col gap-2">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                      ...
                      className="shrink-0 flex h-7 w-7 items-center justify-center rounded-full text-[#B8B5C4] transition-colors hover:bg-[var(--color-primary)]/10 hover:text-[var(--color-primary)]"
                    >
                  ...
                  {v.scheduled ? (
                    <div className="flex items-center justify-between gap-2 rounded-xl bg-[#DFF6EA] px-3 py-2">
                      ...
                      <button
                        ...
                        className="text-[10.5px] font-bold text-[#8A8A8A] hover:text-[var(--color-primary)]"
                      >
                        Retirer
                      </button>
                    </div>
                    ...
                    <div className="rounded-xl border border-[#E4E1F5] p-3 space-y-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 rounded-full bg-[var(--color-primary)] py-1.5 text-[12px] font-bold text-white"
                        >
                          Programmer
                        </button>
                        <button
                    ...
                    <button
                      ...
                      className="mt-auto inline-flex items-center justify-center gap-1.5 rounded-full border border-[#E4E1F5] px-3 py-2 text-[12px] font-bold hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] disabled:opacity-40 transition-colors"
                    >
...
function StepTitle({ n, title, hint }: { n: string; title: string; hint?: string }) {
  return (
    <div className="mb-3 flex items-baseline gap-2.5">
      <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[var(--color-primary)] text-[12px] font-black text-white shrink-0 translate-y-0.5">
        {n}
      </span>
...
function ModeCard({
  ...
  return (
    <button
      ...
      style={active ? { outline: "3px solid var(--color-primary)", outlineOffset: 3 } : undefined}
    >
      {active && (
        <span className="absolute top-2.5 right-2.5 flex h-5 w-5 items-center justify-center rounded-full bg-[var(--color-primary)] text-white">
          <Icon name="Check" size={12} />
        </span>
      )}
      <span className="text-[28px]">{emoji}</span>
      <span>
        <span className={cn("block text-[14.5px] font-bold", active && "text-[var(--color-primary)]")}>{title}</span>
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5">
      ...
      {items.map((t) => (
        <button
          ...
          style={selected?.id === t.id ? { outline: "3px solid var(--color-primary)", outlineOffset: 2 } : undefined}
        >
          ...
          {selected?.id === t.id && (
            <span className="absolute top-1.5 right-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-[var(--color-primary)] text-white">
              <Icon name="Check" size={12} />
            </span>
          )}
        </button>
...
function FilterSelect({
  ...
  return (
    <select
      ...
      className="rounded-full border border-[#E4E1F5] bg-white px-3 py-1.5 text-[12.5px] font-semibold outline-none focus:border-[var(--color-primary)]"
    >
      {options.map(([v, label]) => (
