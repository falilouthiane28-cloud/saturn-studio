...
export const metadata = {
  title: "Héberger sur un VPS · saturn",
  description:
    ...
    <div className="bronx-page lv-snap min-h-screen w-full">
              ...
              },
              {
                ...
                node: (
                  <div className="w-full max-w-[900px]">
                    ...
                    />
                    <div className="mt-3 rounded-xl border-2 border-dashed border-[var(--color-primary)] bg-[#FFF6F2] px-4 py-2.5 text-[13.5px] leading-snug">
                      <b className="text-[var(--color-primary)]">Important :</b> il te demande le mot de passe, mais
        ...
        <div className="lv-board">
          ...
          <div className="lv-fig">
            <CmdList
              ...
              items={[
                {
                  cmd: "pm2 start npm --name saturn -- run start",
                  why: <>Démarre ton site et le confie à <b>pm2</b>. <b>--name saturn</b> lui donne un nom, pour pouvoir le retrouver après.</>,
                },
                {
          ...
          <div className="lv-why">
            ...
            <span className="lv-mt"> pm2 logs saturn</span>.
          </div>
        </div>
      </section>
          ...
          <div className="lv-fig">
            <div className="w-full max-w-[980px]">
              ...
              <CmdList
                ...
                items={[
                  {
                    cmd: "nano /etc/nginx/sites-available/saturn",
              ...
              <div className="mt-2.5">
                <CmdList
                  ...
                  items={[
                    {
                      cmd: "ln -s /etc/nginx/sites-available/saturn /etc/nginx/sites-enabled/",
            ...
            <div className="grid w-full max-w-[1060px] items-start gap-4 lg:grid-cols-[1.1fr_1fr]">
              <CmdList
                ...
                items={[
                  ...
                  {
                    cmd: "htpasswd -c /etc/nginx/.htpasswd saturn",
                    why: <>Crée l&apos;identifiant <b>saturn</b>. Il te demande alors de choisir un mot de passe (deux fois).</>,
                  },
                  {
                    cmd: "nano /etc/nginx/sites-available/saturn",
      ...
      <section className="lv-slide" id="v-fin">
        <div className="lv-board dark">
          <div className="lv-eyebrow" style={{ color: "#9333EA" }}>C&apos;est en ligne</div>
                ...
                <ol className="space-y-1.5">
                  {[
                    ...
                    <li key={s} className="lv-in flex gap-2.5 text-[13.5px] text-white" style={{ ["--d" as string]: `${i * 0.1}s` }}>
                      <span className="flex h-[19px] w-[19px] shrink-0 items-center justify-center rounded-full bg-[var(--color-primary)] text-[10.5px] font-black">
                        {i + 1}
                      </span>
                      {s}
                    </li>
              ...
              <div className="space-y-3">
                <div className="rounded-2xl bg-white p-4">
                  ...
                  <ul className="space-y-2 text-[13px] text-[#3A3A3A]">
                    <li><span className="lv-mt font-bold">pm2 logs saturn</span><br />Le site ne s&apos;affiche pas : regarde ici, l&apos;erreur y est écrite.</li>
                    <li><span className="lv-mt font-bold">pm2 restart saturn</span><br />Redémarre le site s&apos;il s&apos;est bloqué.</li>
        ...
        {items.map((it, i) => (
          ...
          >
            <div className="flex gap-2 bg-[#12101E] px-3.5 py-2.5 font-mono text-[12.5px] leading-snug text-white">
              <span className="shrink-0 font-bold text-[var(--color-primary)]">$</span>
...
function Box({ label, sub, tone }: { label: string; sub: string; tone: "lav" | "mint" | "peach" }) {
  const bg = tone === "lav" ? "#DCD3FF" : tone === "mint" ? "#C6EEDB" : "#EDE4FD";
  return (
