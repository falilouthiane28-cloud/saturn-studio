...
- Commence ta réponse par un titre markdown (\`# ...\`) qui reflète le livrable (ex. \`# Post LinkedIn — lancement l'Agent SDR\`, \`# Brief de campagne — Q2 2026\`).
...
1. **l'equipeum 5 appels web par réponse** — reste parcimonieux, priorise les sources primaires.
