    ...
    <div className="bronx-page lv-snap min-h-screen w-full">
        ...
        <div className="lv-board mint">
          ...
          <div className="lv-fig">
            <svg viewBox="0 0 1200 470">
              ...
              <Finder x={70} y={70} title="Téléchargements" active="saturn.zip"
                items={["saturn.zip", "photo-produit.jpg", "facture.pdf"]} />
        ...
        <div className="lv-board">
          ...
          <Todo
            items={[
              ...
              <>Repère <B>saturn.zip</B> et fais un <B>double-clic</B> dessus.</>,
          ...
          <div className="lv-fig">
            <svg viewBox="0 0 1200 460">
              ...
              <Finder x={70} y={110} title="Téléchargements" active="saturn.zip" items={["saturn.zip"]} />
      ...
      <section className="lv-slide" id="in3">
        <div className="lv-board peach">
          ...
          <div className="flex flex-wrap items-center gap-y-2">
            ...
            <span className="ml-2 self-center rounded-md border-2 border-[var(--color-primary)] bg-white px-2 py-0.5 text-[13px] font-black text-[var(--color-primary)]">
            ...
            <svg viewBox="0 0 1200 440">
              ...
              >
                ...
                <g className="lv-in" style={{ ["--d" as string]: "0.6s" }}>
                  <rect x="186" y="130" width="352" height="140" rx="14" fill="#FFF6F2" stroke="var(--color-primary)" strokeWidth="2" />
                  ...
                  <g className="lv-blink">
                    <text x="214" y="252" fontSize="12" fontWeight="700" fill="var(--color-primary)">↑ toujours celle du haut (recommandée)</text>
                  </g>
                </g>
              </ClaudeWin>
            </svg>
                ...
                node: (
                  <ToolGuide
                    ...
                    steps={[
                      ...
                      <>Clique sur le bouton noir <B>« Create Key »</B>, donne un nom (ex. <i>saturn</i>) et valide.</>,
          ...
          <div className="lv-fig">
            <svg viewBox="0 0 1200 480">
              ...
              <g className="lv-pop">
                ...
                <AgentPic slug="fireflies" x={824} y={186} size={66} />
                <rect x="930" y="180" width="56" height="78" rx="12" fill="#EDE4FD" />
                <AgentPic slug="createur-contenu" x={934} y={196} size={48} />
                <rect x="998" y="180" width="56" height="78" rx="12" fill="#C6EEDB" />
                <AgentPic slug="veille" x={1002} y={196} size={48} />
                <rect x="1066" y="180" width="56" height="78" rx="12" fill="#DCD3FF" />
                <AgentPic slug="proposition" x={1070} y={196} size={48} />
      ...
      <section className="lv-slide" id="in-fin">
        <div className="lv-board dark">
          <div className="lv-eyebrow" style={{ color: "#9333EA" }}>C&apos;est installé</div>
      ...
      <div className="grid items-start gap-4 lg:grid-cols-[1.05fr_1fr]">
        ...
        <div className="rounded-2xl border-2 border-[#0F0F0F] bg-white p-4 text-left shadow-[4px_4px_0_rgba(15,15,15,0.1)]">
          <div className="mb-3 flex items-center gap-2">
            ...
            {required ? (
              <span className="rounded-full bg-[var(--color-primary)] px-2 py-0.5 text-[10px] font-black text-white">obligatoire</span>
            ) : (
          ...
          {warn && (
            <div className="mt-3 rounded-xl border-2 border-dashed border-[var(--color-primary)] bg-[#FFF6F2] px-3 py-2 text-[12.5px] leading-snug text-[#3A3A3A]">
              <span className="mr-1 font-black text-[var(--color-primary)]">Attention&nbsp;:</span>
              {warn}
            </div>
          )}
  ...
  return (
    <div className="overflow-hidden rounded-2xl border-[2.5px] border-[#0F0F0F] bg-white shadow-[0_18px_44px_-22px_rgba(15,15,15,0.4)]">
      ...
      <div className="flex items-center gap-2 border-b border-[#E6E4EE] bg-[#F3F2F7] px-3.5 py-2.5">
        ...
        {required && (
          <span className="ml-auto shrink-0 rounded-full bg-[var(--color-primary)] px-2 py-0.5 text-[10px] font-black text-white">
            obligatoire
          </span>
        )}
      </div>
      <div className="flex text-left">
        ...
        <div className="flex-1 p-4">
          ...
          <div className="relative rounded-xl border-2 border-dashed border-[var(--color-primary)] bg-[#FFF8F5] p-3.5">
            <span className="absolute -top-3 left-4 rounded-full bg-[var(--color-primary)] px-2.5 py-1 text-[10.5px] font-black text-white shadow">
              ta clé est ici
            </span>
            ...
            <div className="flex items-center gap-2 rounded-lg border border-[#E4E1F5] bg-white px-2.5 py-2">
              ...
              <span className="shrink-0 rounded-md bg-[var(--color-primary)] px-2 py-1 text-[10px] font-bold text-white">
                Copier
              </span>
            </div>
          </div>
