...
export const MOCK_CANDIDATES: MockCandidate[] = [
  {
    ...
    email: "leo.vermeersch.test@saturnagency.com",
  ...
  },
  {
    ...
    email: "camille.durand.test@saturnagency.com",
    appliedFor: "job-ai-eng",
  ...
  },
  {
    ...
    email: "alexandre.mercier.test@saturnagency.com",
    appliedFor: "job-ai-eng",
  ...
  },
  {
    ...
    email: "sami.benali.test@saturnagency.com",
    ...
    highlights: [
      ...
      "Connaît Fallou via LinkedIn (follower actif)",
    ],
    redFlags: [
  ...
  },
  {
    ...
    email: "margaux.touffreau.test@saturnagency.com",
    appliedFor: "job-account",
